...
router.get("/api/interessados", (req, res) => InteressadosController.interessadosCriar(req, res));
router.post("/api/interessados", (req, res) => InteressadosController.interessadosPostAsync(req, res));
